...
for (i in 1:3){
  res[[i]]=foreach(icount(1000)) %dopar% funsimt(response.probs = c(null.response.probs,null.response.probs), 
...
names(pstop)<-c("15Coin","15Urn","15Block","30Coin","30Urn","30Block","50Coin","50Urn","50Block")
pstop
